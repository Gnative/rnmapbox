...
import { makeLatLngBounds, makePoint } from "../utils/geoUtils.js";
import NativeCameraView from '../specs/RNMBXCameraNativeComponent';
import RNMBXCameraModule from "../specs/NativeRNMBXCameraModule.js";
...
function validPaddingConfig2(paddingConfig) {
  return paddingConfig.length === 2;
}
function validPaddingConfig4(paddingConfig) {
