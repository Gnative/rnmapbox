...
Object.defineProperty(exports, "OfflineLegacyCreatePackOptions", {
  enumerable: true,
  get: function () {
    return _OfflineLegacyCreatePackOptions.default;
  }
});
exports.default = exports.OfflineModuleEventEmitter = void 0;
var _reactNative = require("react-native");
var _utils = require("../../utils");
var _OfflineLegacyCreatePackOptions = _interopRequireDefault(require("./OfflineLegacyCreatePackOptions"));
...
class OfflineManagerLegacy {
  ...
  async createPack(options, progressListener, errorListener) {
    ...
    const packOptions = new _OfflineLegacyCreatePackOptions.default(options);
